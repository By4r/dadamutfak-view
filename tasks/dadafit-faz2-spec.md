...
> **READ-ONLY shared reference.** Hub (`v6/dadafit-hub-v1.html`) FAZ 2'nin görsel
...
## 1 · Egzersiz Kütüphane — `v6/egzersiz-kutuphane-v1.html`  (teammate: egzersiz-kutuphane)
...
## 2 · Egzersiz Detay — `v6/egzersiz-detay-v1.html`  (teammate: egzersiz-detay)  ⚠️ EN AĞIR
...
## 3 · Program Detay — `v6/program-detay-v1.html`  (teammate: program-detay)
...
## 4 · TDEE / Beslenme↔Hareket Köprü — `v6/dadafit-kopru-v1.html`  (teammate: tdee-kopru)
...
|---|---|---|
| egzersiz-kutuphane | `v6/egzersiz-kutuphane-v1.html` | hub, header-blok |
| egzersiz-detay | `v6/egzersiz-detay-v1.html` | hub, header-blok, dyt-recete-builder |
| program-detay | `v6/program-detay-v1.html` | hub, header-blok |
| tdee-kopru | `v6/dadafit-kopru-v1.html` | hub, header-blok, gunluk-kalori |
</content>
</invoke>
