...
|---|---|---|
| **Yatay (lockup)** renkli | `brand/logo.pdf` s.1 → `v6/assets/img/logo-official.png` (2975×694) | Açık zemin / katı (scroll'lu) header |
| **Yatay** mono-beyaz | `v6/assets/img/logo-official-white.png` | Koyu/şeffaf header + turuncu footer |
